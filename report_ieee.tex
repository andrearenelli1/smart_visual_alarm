...
${\approx}8\,\%$ (Figs.~\ref{fig:latency_box}--\ref{fig:latency_layer}).
Early DS blocks on larger feature maps are 1.5--3$\times$ slower than
later ones. Total: 351\,ms (${\approx}2.85$\,FPS).

\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\columnwidth]{stats_boxplot.png}
...
firmware-default $\theta\!=\!0.60$ was selected by combining
benchmark results with on-site validation in a typical indoor
environment: thresholds below ${\approx}0.55$ produced false alarms
